  ...
  <div class="wrapper">
    <header id="1" class="header">
      <div class="container header__inner">
        ...
        <div class="about us"> 
            <div class="container">
				<h2 class="h2__title">Акции</h2>
				<div class="bread-crumb">
					<a href="index.php">Главная</a>
					<span> / </span>
					<a href="stocks.php">Акции</a>
				</div>
                <div class="stocks1">
                  <img style="margin:0 0 0 187px;" src="img/stocks/stocks1.png" alt/>
			          </div>
                <div class="stocks2">
                  <img style="margin:0 0 0 39px;" src="img/stocks/stocks2.png" alt/>
			          </div>
                <div class="stocks3">
                  <img style="margin:0 0 0 39px;" src="img/stocks/stocks3.png" alt/>
			          </div>
			</div>
		</div>
		</section>
