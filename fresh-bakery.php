		...
		<div class="wrapper">
			...
			<main class="main">
				...
				<div class="popular-food">
					<div class="container">
						<h2 class="h2__title">Свежая выпечка</h2>
						<div class="bread-crumb">
							<a href="index.php">Главная</a>
							<span> / </span>
							<a href="fresh-bakery.php">Свежая выпечка</a>
						</div>
						<div class="cardholder cardholder__margin">
							<div class="card">
								<img class="card__img" src="img/fresh-bakery/fresh-bakery1.jpg" alt>
								<h4 class="card__title">Лепешка из дрожжевого теста</h4>
								<div class="card__gramm-bg">
									<p class="card__gram">70 г</p>
								</div>
								<p class="card__structure">Молоко, мука, дрожжи, кунжут. Приготовлена в
									тандыре
								</p>
								...
								<div class="card__buy">
									...
									<button class="inbasket" data-sb-id-or-vendor-code="201"
										data-sb-product-name="Лепешка из дрожжевого теста"
										data-sb-product-price="100" data-sb-product-quantity="1"
										data-sb-product-img="img/fresh-bakery/fresh-bakery1.jpg">
										<i class="fa-solid fa-basket-shopping"></i>
									</button>
								</div>
							</div>
							<div class="card">
								<img class="card__img" src="img/fresh-bakery/fresh-bakery2.jpg" alt>
								<h4 class="card__title">Острая лепешка</h4>
								<div class="card__gramm-bg">
									<p class="card__gram">100 г</p>
								</div>
								<p class="card__structure">Йогурт, мука, зира, острый перец.
									Приготовлена на огне</p>
								<div class="card__buy">
									<div class="cost__block">
										<p class="card__cost">100 ₽</p>
									</div>
									...
									<div class="product__quantity"></div>
									<button class="inbasket" data-sb-id-or-vendor-code="202"
										data-sb-product-name="Острая лепешка"
										data-sb-product-price="100" data-sb-product-quantity="1"
										data-sb-product-img="img/fresh-bakery/fresh-bakery2.jpg">
										<i class="fa-solid fa-basket-shopping"></i>
									</button>
								</div>
							</div>
							<div class="card">
								<img class="card__img" src="img/fresh-bakery/fresh-bakery3.jpg" alt>
								<h4 class="card__title">Экмек</h4>
								<div class="card__gramm-bg">
									<p class="card__gram">70 г</p>
								</div>
								<p class="card__structure">Сливки, оливковое масло, мука, кунжут</p>
								...
								<div class="card__buy">
									...
									<div class="product__quantity"></div>
									<button class="inbasket" data-sb-id-or-vendor-code="203"
										data-sb-product-name="Экмек"
										data-sb-product-price="100" data-sb-product-quantity="1"
										data-sb-product-img="img/fresh-bakery/fresh-bakery3.jpg">
										<i class="fa-solid fa-basket-shopping"></i>
									</button>
								</div>
							</div>
