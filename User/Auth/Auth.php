...
<html lang="en">
  ...
  <header id="1" class="header"> <div class="header__inner" style="
    padding-left: 30px;
    padding-right: 30px;
">
  ...
  <body>  
    <div class="container">
      <div class="content">
        <h1><span style="font-weight:bold"; style="font-size:36px">Авторизация</span></h1>
        <br>
        <form method="post" action="../../vendor/Auth/SignIn.php">
          ...
          <button type="submit" class="btnPrimary">Войти</button>
          <p style="min-width: 350px; text-align: center">
            Не зарегистрированы? -
            <a style="text-decoration: none; color: #fff;" href="User/Auth/Register.php">Зарегистрироваться</a>
          </p>
        </form>
      </div>
    </div>
