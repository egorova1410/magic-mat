				...
				<div class="popular-food">
					<div class="container">
						...
						<div class="cardholder cardholder__margin">
							<div class="card">
								<img class="card__img" src="img/sauces/sauces1.jpg" alt>
								<h4 class="card__title">Мацони</h4>
								<div class="card__gramm-bg">
									<p class="card__gram">30 г</p>
								</div>
								<p class="card__structure"></p>
								<div class="card__buy">
									<div class="cost__block">
										<p class="card__cost-old"></p>
										<p class="card__cost">110 ₽</p>
									</div>
									<div class="product__quantity"></div>
									<button class="inbasket" data-sb-id-or-vendor-code="501"
										data-sb-product-name="Мацони"
										data-sb-product-price="110" data-sb-product-quantity="1"
										data-sb-product-img="img/sauces/sauces1.jpg">
							...
							<div class="card">
								<img class="card__img" src="img/sauces/sauces2.jpg" alt>
								<h4 class="card__title">Песто</h4>
								<div class="card__gramm-bg">
									<p class="card__gram">30 г</p>
								</div>
								<p class="card__structure"></p>
								<div class="card__buy">
									...
									<div class="product__quantity"></div>
									<button class="inbasket" data-sb-id-or-vendor-code="502"
										data-sb-product-name="Песто"
										data-sb-product-price="110" data-sb-product-quantity="1"
										data-sb-product-img="img/sauces/sauces2.jpg">
										<i class="fa-solid fa-basket-shopping"></i>
									</button>
								</div>
							</div>
							...
							<div class="card">
								<img class="card__img" src="img/sauces/sauces3.jpg" alt>
								<h4 class="card__title">Рустер</h4>
								<div class="card__gramm-bg">
									<p class="card__gram">30 г</p>
								</div>
								<p class="card__structure"></p>
								<div class="card__buy">
									...
									<div class="product__quantity"></div>
									<button class="inbasket" data-sb-id-or-vendor-code="503"
										data-sb-product-name="Рустер"
										data-sb-product-price="110" data-sb-product-quantity="1"
										data-sb-product-img="img/sauces/sauces3.jpg">
										<i class="fa-solid fa-basket-shopping"></i>
									</button>
								</div>
							</div>
							...
							<div class="card">
								<img class="card__img" src="img/sauces/sauces4.jpg" alt>
								<h4 class="card__title">Соевый</h4>
								<div class="card__gramm-bg">
									<p class="card__gram">30 г</p>
								</div>
								<p class="card__structure"></p>
								<div class="card__buy">
									...
									<div class="product__quantity"></div>
									<button class="inbasket" data-sb-id-or-vendor-code="504"
										data-sb-product-name="Соевый"
										data-sb-product-price="110" data-sb-product-quantity="1"
										data-sb-product-img="img/sauces/sauces4.jpg">
										<i class="fa-solid fa-basket-shopping"></i>
									</button>
								</div>
							</div>
							...
							<div class="card">
								<img class="card__img" src="img/sauces/sauces5.jpg" alt>
								<h4 class="card__title">Чатни</h4>
								<div class="card__gramm-bg">
									<p class="card__gram">30 г</p>
								</div>
								<p class="card__structure"></p>
								<div class="card__buy">
									...
									<div class="product__quantity"></div>
									<button class="inbasket" data-sb-id-or-vendor-code="505"
										data-sb-product-name="Чатни"
										data-sb-product-price="110" data-sb-product-quantity="1"
										data-sb-product-img="img/sauces/sauces5.jpg">
										<i class="fa-solid fa-basket-shopping"></i>
									</button>
								</div>
							</div>
							...
							<div class="card">
								<img class="card__img" src="img/sauces/sauces6.jpg" alt>
								<h4 class="card__title">Чимичурри</h4>
								<div class="card__gramm-bg">
									<p class="card__gram">30 г</p>
								</div>
								<p class="card__structure"></p>
								<div class="card__buy">
									...
									<div class="product__quantity"></div>
									<button class="inbasket" data-sb-id-or-vendor-code="506"
										data-sb-product-name="Чимичурри"
										data-sb-product-price="110" data-sb-product-quantity="1"
										data-sb-product-img="img/sauces/sauces6.jpg">
										<i class="fa-solid fa-basket-shopping"></i>
									</button>
								</div>
							</div>
							...
							<div class="card">
								<img class="card__img" src="img/sauces/sauces7.jpg" alt>
								<h4 class="card__title">Аджика</h4>
								<div class="card__gramm-bg">
									<p class="card__gram">30 г</p>
								</div>
								<p class="card__structure"></p>
								<div class="card__buy">
									...
									<div class="product__quantity"></div>
									<button class="inbasket" data-sb-id-or-vendor-code="507"
										data-sb-product-name="Аджика"
										data-sb-product-price="110" data-sb-product-quantity="1"
										data-sb-product-img="img/sauces/sauces7.jpg">
										<i class="fa-solid fa-basket-shopping"></i>
									</button>
								</div>
							</div>
							...
							<div class="card">
								<img class="card__img" src="img/sauces/sauces8.jpg" alt>
								<h4 class="card__title">Гранатовый</h4>
								<div class="card__gramm-bg">
									<p class="card__gram">30 г</p>
								</div>
								<p class="card__structure"></p>
								<div class="card__buy">
									...
									<div class="product__quantity"></div>
									<button class="inbasket" data-sb-id-or-vendor-code="508"
										data-sb-product-name="Гранатовый"
										data-sb-product-price="110" data-sb-product-quantity="1"
										data-sb-product-img="img/sauces/sauces8.jpg">
										<i class="fa-solid fa-basket-shopping"></i>
									</button>
								</div>
							</div>
