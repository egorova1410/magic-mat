      ...
      (e = {
        ...
        deleteProducts: function (a, s) {
          let r = t("<button>")
            ...
            .php('<span class="smart-basket__delete-icon">×</span>');
          return (
            r.click(function (r) {
              r.preventDefault();
        ...
        showProducts: function (s) {
          let r = t("<form>").attr({
            ...
            d = t("<span>")
              ...
              .php("Цена за 1 товар или услугу")
              .append(p),
            u = t("<div>")
              .attr({ class: "smart-basket__product-price" })
              .php(`Цена / ${a.smartBasketCurrency}`)
              .append(c)
              .append(d);
          c.click(() => {
            d.fadeToggle();
          ...
          let m = t("<div>")
              ...
              .php(`Общая цена / ${a.smartBasketCurrency}`),
            k = t("<div>")
              .attr({ class: "smart-basket__product-delete" })
              .text("Удалить");
            ...
            for (let a in s[n]) {
              ...
              if (
                ...
                "sbSize" === a &&
                  ...
                  d.val(s[n][a])),
                "sbPrice" === a && (_.php(s[n][a]), h.val(s[n][a])),
                "sbPriceCommon" === a)
              ) {
                let t = +s[n][a];
                y.val(+t.toFixed(2));
        ...
        commonResult: function (e, s, r) {
          ...
          if ((0 == +n ? o.fadeIn() : o.fadeOut(), r))
            ...
            if (!s)
              return (
                d.php(`<span>Всего товаров: </span> ${n}`),
                p.php(
            ...
            0 == +n && t("." + o.attr("class")).css("display", "block"),
              t("." + d.attr("class")).php("<span>Всего товаров: </span> "),
              t("." + d.attr("class")).php(`<span>Всего товаров: </span> ${n}`),
              t("." + p.attr("class")).php("<span>Общая стоимость: </span> "),
              t("." + p.attr("class")).php(
                `<span>Общая стоимость: </span> <input name="finalPrice" class="smart-basket__total-cost" type="text" value="${i.toFixed(
                  2
                )} ${a.smartBasketCurrency}">`
